...
const initialCollections = {
  ...
  Tasks: [
    {
      id: 'task_1', title: 'Build a Personal Portfolio Site',
      description: 'Create a responsive personal portfolio website using React. Include sections for About, Projects, Skills, and Contact.',
      category: 'Web Development', taskType: 'coding', difficulty: 'easy',
      tags: ['React', 'CSS', 'Portfolio'],
      visibility: 'all', selectedDepartments: [],
      publishDate: '2026-07-01T00:00:00Z', dueDate: '2026-07-15', dueTime: '23:59',
      estimatedTime: '2-3 hours',
      xpReward: 100, maxEarlyBonusXP: 20, earlySubmissionDays: 3,
      badgeReward: null, badgeIsCustom: false,
      allowMultipleSubmissions: false, maxAttempts: 1,
      lateSubmissionAllowed: false, showLeaderboard: true, showScoresImmediately: true, anonymousReview: false,
      instructions: '<p>Build a personal portfolio website that showcases your work. Focus on clean design and responsive layout.</p>',
      resources: { githubRepo: '', docLink: '', youtubeVideo: '', driveLink: '' },
      requiredFields: { githubRepo: true, technologies: true },
      status: 'open', createdBy: 'admin', createdAt: '2026-06-28T08:00:00Z', updatedAt: '2026-06-28T08:00:00Z', totalSubmissions: 0,
    },
    {
      id: 'task_2', title: 'AI-Powered Chatbot Concept',
      description: 'Propose an innovative AI-powered chatbot concept for campus assistance. Define the problem, solution, and key features.',
      category: 'AI', taskType: 'idea', difficulty: 'medium',
      tags: ['AI', 'Chatbot', 'Innovation'],
      visibility: 'all', selectedDepartments: [],
      publishDate: '2026-07-05T00:00:00Z', dueDate: '2026-07-20', dueTime: '23:59',
      estimatedTime: '1-2 hours',
      xpReward: 150, maxEarlyBonusXP: 30, earlySubmissionDays: 3,
      badgeReward: null, badgeIsCustom: false,
      allowMultipleSubmissions: true, maxAttempts: 2,
      lateSubmissionAllowed: true, showLeaderboard: true, showScoresImmediately: true, anonymousReview: false,
      instructions: '<p>Think of an AI chatbot concept that could help students on campus. Be creative and detailed in your proposal.</p>',
      resources: { githubRepo: '', docLink: '', youtubeVideo: '', driveLink: '' },
      requiredFields: { projectTitle: true, problemStatement: true, proposedSolution: true },
      status: 'open', createdBy: 'admin', createdAt: '2026-06-30T10:00:00Z', updatedAt: '2026-06-30T10:00:00Z', totalSubmissions: 0,
    },
    {
      id: 'task_3', title: 'ML Model for Image Classification',
      description: 'Build and train a machine learning model to classify images from a dataset of your choice.',
      category: 'Machine Learning', taskType: 'ai', difficulty: 'hard',
      tags: ['ML', 'Image Classification', 'Python'],
      visibility: 'all', selectedDepartments: [],
      publishDate: '2026-07-10T00:00:00Z', dueDate: '2026-07-25', dueTime: '23:59',
      estimatedTime: '4-6 hours',
      xpReward: 250, maxEarlyBonusXP: 50, earlySubmissionDays: 3,
      badgeReward: 'ai_explorer', badgeIsCustom: false,
      allowMultipleSubmissions: false, maxAttempts: 1,
      lateSubmissionAllowed: false, showLeaderboard: true, showScoresImmediately: true, anonymousReview: false,
      instructions: '<p>Choose a dataset, preprocess it, and train a CNN or transfer learning model. Document your approach and results.</p>',
      resources: { githubRepo: '', docLink: '', youtubeVideo: '', driveLink: '' },
      requiredFields: { modelDescription: true, datasetUsed: true },
      status: 'published', createdBy: 'admin', createdAt: '2026-07-02T08:00:00Z', updatedAt: '2026-07-02T08:00:00Z', totalSubmissions: 0,
    },
  ],
  TaskSubmissions: [],
  TaskReviews: [],
